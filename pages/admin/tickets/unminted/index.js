...
const UnmintedTicketList = () => {
    const { data, error, isValidating, mutate } = useSWR(
        '/tickets.json?orderBy="isMinted"&equalTo=false&print=pretty'
    )
    ...
    const datatable = () => {
        ...
        tickets && tickets.forEach(ticket => {
            data.rows.push({
                ...
                status: <p style={{ color: 'red' }}>Unminted</p>,
...
export default UnmintedTicketList